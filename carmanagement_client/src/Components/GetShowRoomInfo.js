...
showButton = () => { 
  ...
  componentDidMount(){
    var self = this;
    fetch('http://localhost:8000/api/v1/get-car-by-showroom/?showroom='+this.props.match.params.id,)
    .then(function (res){
        return res.json();
    })
    .then(function(data){
    ...
    fetch('http://localhost:8000/api/v1/single-showroom/'+this.props.match.params.id,)
    .then(function (res){
        return res.json();
    })
    .then(function(data){
