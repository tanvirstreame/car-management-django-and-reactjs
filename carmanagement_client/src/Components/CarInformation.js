...
showButton = () => { 
  ...
  componentDidMount(){
    var self = this;
    fetch('http://127.0.0.1:8000/api/v1/single-car-detail/'+this.props.match.params.id,)
    .then(function (res){
        return res.json();
    })
    .then(function(data){
    ...
    fetch('http://127.0.0.1:8000/api/v1/single-car-image/?car='+this.props.match.params.id,)
    .then(function (res){
        return res.json();
    })
    .then(function(data){
