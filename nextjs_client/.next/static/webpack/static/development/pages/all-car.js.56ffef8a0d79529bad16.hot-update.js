...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CarInformation, [{
    ...
    value: function componentDidMount() {
      var self = this;
      fetch('http://127.0.0.1:8000/api/v1/single-car-detail/' + this.props.query).then(function (res) {
      ...
      fetch('http://127.0.0.1:8000/api/v1/single-car-image/?car=' + this.props.query).then(function (res) {
        return res.json();
      }).then(function (data) {
        self.setState({
          image: data
...
//# sourceMappingURL=all-car.js.56ffef8a0d79529bad16.hot-update.js.map